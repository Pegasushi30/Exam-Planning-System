...
$sql = "SELECT * FROM courses WHERE department_id=(SELECT department_id FROM users WHERE username='$username')";
...
<div class="container">
    ...
    <h3>Add New Department Course</h3>
    <form method="post" action="../forms/insert_department_course.php">
